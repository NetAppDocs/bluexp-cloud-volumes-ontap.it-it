...
IMPORTANT: NetApp deprecerà a breve le licenze basate su nodi, che verranno sostituite da licenze basate sulla capacità. Per informazioni, fare riferimento alla https://mysupport.netapp.com/info/communications/CPC-00589.html["Comunicazione con i clienti: CPC-00589"^].
