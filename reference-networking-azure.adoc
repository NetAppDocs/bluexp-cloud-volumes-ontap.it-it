...
TIP: Cerchi informazioni sul connettore? https://docs.netapp.com/us-en/cloud-manager-setup-admin/reference-ports-azure.html["Visualizzare le regole del gruppo di protezione per il connettore"^]
...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-azure.html["Visualizzare i requisiti di rete per il connettore"^]
