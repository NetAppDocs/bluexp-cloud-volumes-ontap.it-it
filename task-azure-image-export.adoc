...
NOTE: Per ulteriori informazioni su come installare l'interfaccia della riga di comando di Azure, vedere https://learn.microsoft.com/en-us/cli/azure/install-azure-cli["Documentazione di Azure: Come installare l'interfaccia della riga di comando di Azure"^].
...
. Esaminare il nome SKU per il tipo di implementazione VM corrispondente riportato nella tabella seguente.
+
