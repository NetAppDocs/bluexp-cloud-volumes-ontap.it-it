...
Se non è possibile modificare il tipo di istanza da istanze C4, M4 o R4, vedere l'articolo della Knowledge base link:https://kb.netapp.com/Cloud/Cloud_Volumes_ONTAP/Converting_an_AWS_Xen_CVO_instance_to_Nitro_(KVM)["Conversione di un'istanza CVO Xen di AWS in Nitro (KVM)"^].
