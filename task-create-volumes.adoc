...
| Tag | I tag aggiunti a un volume vengono associati a https://docs.netapp.com/us-en/cloud-manager-app-template/task-using-tags.html["Servizio modelli di applicazione"^], che consente di organizzare e semplificare la gestione delle risorse. 
