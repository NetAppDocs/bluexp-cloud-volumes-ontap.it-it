...
NOTE: L'implementazione diretta del marketplace Azure supporta i tipi di istanze L8s_v3. Tuttavia, BlueXP  non supporta questo tipo di istanza per le configurazioni ha e non sarà in grado di rilevarlo correttamente durante il rilevamento.
