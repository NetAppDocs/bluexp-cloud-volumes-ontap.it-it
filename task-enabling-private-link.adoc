...
https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-configuring-proxy.html#enable-a-proxy-on-a-connector["Scopri come attivare il traffico API diretto sul connettore"^]
