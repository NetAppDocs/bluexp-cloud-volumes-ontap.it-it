...
---
= Converti immagine Google Cloud in formato RAW per Cloud Volumes ONTAP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Per ulteriori informazioni su come esportare un'immagine tramite Google Cloud, fare riferimento a https://cloud.google.com/compute/docs/images/export-image#console["Documento Google Cloud sull'esportazione di un'immagine"^].
