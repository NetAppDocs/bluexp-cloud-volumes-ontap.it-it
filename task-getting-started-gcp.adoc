...
.Link correlati
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-google.html["Creazione di un connettore da BlueXP"^]
...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/reference-permissions-gcp.html["Cosa fa BlueXP con le autorizzazioni Google Cloud"^]
