...
Per informazioni su cosa accade ai dati Cloud Volumes ONTAP alla scadenza o alla rimozione della licenza, fare riferimento a https://kb.netapp.com/Cloud/Cloud_Volumes_ONTAP/FAQs_on_Cloud_Volumes_ONTAP_license_expiry["Questo articolo della Knowledge base (KB)"^].
