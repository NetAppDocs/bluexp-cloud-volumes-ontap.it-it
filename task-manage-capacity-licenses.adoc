...
NOTE: Per ulteriori informazioni su come ottenere un file di licenza, vedere https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-manage-node-licenses.html#obtain-a-system-license-file["Ottenere un file di licenza di sistema"^].
