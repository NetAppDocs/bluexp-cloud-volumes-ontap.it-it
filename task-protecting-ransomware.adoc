...
La funzionalità ARP è disponibile per l'utilizzo con le iscrizioni BYOL e di marketplace per le licenze basate sulla capacità e su nodi, senza costi aggiuntivi. Contattare il rappresentante commerciale NetApp per aggiungere ARP alla licenza corrente.
