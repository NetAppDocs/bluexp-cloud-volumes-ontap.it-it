...
TIP: È possibile gestire gli abbonamenti AWS Marketplace associati agli account AWS dalla pagina Impostazioni > credenziali. https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-aws-accounts.html["Scopri come gestire gli account e gli abbonamenti AWS"^]
