...
TIP: Puoi gestire gli abbonamenti Azure Marketplace associati ai tuoi account Azure dalla pagina Impostazioni > credenziali. https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-azure-accounts.html["Scopri come gestire i tuoi account e abbonamenti Azure"^]
