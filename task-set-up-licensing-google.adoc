...
Scegli l'offerta Freemium per utilizzare Cloud Volumes ONTAP gratuitamente con un massimo di 500 GB di capacità fornita. link:concept-licensing.html#freemium-offering["Scopri di più sull'offerta Freemium"].
...
+
L'abbonamento al marketplace non ti addebiterà alcun costo a meno che non superi i 500 GiB di capacità fornita, dopodiché il sistema viene automaticamente convertito in link:concept-licensing.html#capacity-based-licensing-packages["Pacchetto Essentials"].
...
link:concept-licensing.html#freemium-offering["Scopri di più sulle licenze basate sulla capacità"].
...
. https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-nss-accounts.html#add-an-nss-account["Aggiungi il tuo account NetApp Support Site a BlueXP"^]
+
...
TIP: Puoi gestire gli abbonamenti a Google Cloud Marketplace associati ai tuoi account dalla pagina Impostazioni > credenziali. https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-gcp-accounts.html["Scopri come gestire le tue credenziali e sottoscrizioni Google Cloud"^]
