...
----
Per impostazione predefinita, le autorizzazioni sono incluse nel ruolo personalizzato. https://docs.netapp.com/us-en/cloud-manager-setup-admin/reference-permissions-azure.html["Visualizzare l'autorizzazione Azure per il connettore"^]
...
+
Per assistenza nella replica dei dati, vedere https://docs.netapp.com/us-en/cloud-manager-replication/task-replicating-data.html["Replica dei dati da e verso il cloud"^].
