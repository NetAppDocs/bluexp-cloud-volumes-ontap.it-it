...
+
https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-managing-connectors.html#connect-to-the-linux-vm["Scopri di più sulla connessione a Linux VM per il connettore"^]
