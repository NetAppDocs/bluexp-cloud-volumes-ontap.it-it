...
---
= Verificare il file disk.raw dell'immagine di Google Cloud per Cloud Volumes ONTAP utilizzando OpenSSL
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: I comandi OpenSSL per convalidare l'immagine sono compatibili con i computer Linux, macOS e Windows.
