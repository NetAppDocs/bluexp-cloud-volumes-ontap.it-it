...
In precedenza era possibile abilitare lo storage WORM per la creazione di un ambiente di lavoro Cloud Volumes ONTAP su BlueXP . Ora, BlueXP  offre la possibilità di abilitare IL WORM in un ambiente di lavoro anche se IL WORM non è stato attivato durante la creazione. Una volta attivato, non è possibile disattivare IL WORM.
