...
Cloud Volumes ONTAP ora supporta le seguenti VM della serie Edv5 con dischi gestiti condivisi in zone di disponibilità singole e multiple, a partire dalla release 9.14.1.
